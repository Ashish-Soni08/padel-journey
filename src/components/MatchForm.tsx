...
const MatchForm: React.FC<MatchFormProps> = ({ className, onMatchAdded }) => {
  ...
  return (
    <Card className={cn("w-full max-w-3xl mx-auto glass-panel animate-fade-up", className)} style={{ animationDelay: "0.3s" }}>
      <CardHeader>
        <CardTitle className="text-2xl">Record a Match</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
